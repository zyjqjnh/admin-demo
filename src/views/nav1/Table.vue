<template>
  <section>
    ...
    <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
      <el-form :model="editForm" label="80px" :rules="addFormRules" ref="editForm">
        ...
        <el-form-item label="生日">
          <el-date-picker type="date" placeholder="选择日期" @change="editBirthChange" v-model="editForm.birth"></el-date-picker>
        </el-form-item>
    ...
    <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
      <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
        ...
        <el-form-item label="生日">
          <el-date-picker type="date" placeholder="选择日期" @change="addBirthChange"  v-model="addForm.birth"></el-date-picker>
        </el-form-item>
        <el-form-item label="地址">
...
<script>
  import { getUserListPage, editUser, removeUser, batchRemoveUser, addUser } from '../../api/api'
  export default {
    data () {
      return {
        filters: {
