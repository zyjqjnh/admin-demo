<template>
  <el-form ref="form" :model="form" label-width="80px" style="margin:20px;width:60%;min-width:600px;">
    ...
    <el-form-item label="活动时间">
      <el-col :span="11">
        <el-date-picker type="date" placeholder="选择日期" style="width: 100%" v-model="form.data1"></el-date-picker>
      </el-col>
      <el-col :span="2" style="text-align: center">-</el-col>
      <el-col :span="11">
        <el-time-picker type="fixed-time" placeholder="选择时间" style="width: 100%" v-model="form.data2"></el-time-picker>
      </el-col>
    </el-form-item>
